...
RESULTS_PATH = "/home/blitt/projects/localNews/models/sentEmbeddings/3.0-crossModelAblation/justTranslated"
...
#hold back a copy of the data that has the english
#we will need this for the validation step 
allDf = leanDf.copy(deep=True)

#NOTE: this is what's different about this ablation!
#get just the translated data
...
enDf = allDf[(allDf["url1_lang"] == "en") & (allDf["url2_lang"] == "en")]

#so in this case the train df is only translated data
#and the valid df is only english data 
print("Total train df len: " +  str(len(leanDf)))
print("English df len: " +  str(len(enDf)))

#these lines exist to make it quicker to create this ablation, don't have to refactor as much 
validDf = enDf
trainDf = leanDf
...
validDataset = validDataset.remove_columns(["text1Merged", "text2Merged"])
